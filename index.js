...
//     client.query(`select * from prajituri ${clauzaWhere}`, function(err, res){
//         if(err){
...
//     client.query(`select * from prajituri where id=${req.params.id}`, function(err, res){
//         if(err){
//             console.log("Eroare", err);
//             afisareEroare(res, 2)
//         }
...
function initImagini() {
    ...
    let data = new Date();
    // Ex: data.setHours(12); // Poti modifica aici daca vrei sa testezi diverse ore la restart!
